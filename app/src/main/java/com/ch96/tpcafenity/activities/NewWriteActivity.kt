...
class NewWriteActivity : AppCompatActivity() {
    ...
    private fun clickDone() {
        ...
        //DB 저장하기
        retrofitService.saveEmailAccount(communityPost).enqueue(object : Callback<String> {
            override fun onResponse(call: Call<String>, response: Response<String>) {
                ...
                //커뮤니티로 이동
                val intent = Intent(this@NewWriteActivity, CommunityFragment::class.java)
                startActivity(intent)
                finish()
            }

            override fun onFailure(call: Call<String>, t: Throwable) {
                Toast.makeText(this@NewWriteActivity, " ", Toast.LENGTH_SHORT).show()
